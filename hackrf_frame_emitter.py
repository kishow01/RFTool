...
# Title: Hackrf Frame Emitter
# Generated: Thu Sep 24 12:33:03 2020
##################################################
...
class hackrf_frame_emitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hackrf Frame Emitter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hackrf Frame Emitter")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_frame_emitter")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "/home/kishow/Desktop/new_beacon.pcap", False)
...
def main(top_block_cls=hackrf_frame_emitter, options=None):
