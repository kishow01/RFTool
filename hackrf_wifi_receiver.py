...
# Title: Hackrf Wifi Receiver
# Generated: Thu Sep 24 12:35:11 2020
##################################################
...
class hackrf_wifi_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hackrf Wifi Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hackrf Wifi Receiver")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_wifi_receiver")
        ...
        self.foo_wireshark_connector_1 = foo.wireshark_connector(127, False)
        ...
        self.blocks_file_sink_2 = blocks.file_sink(gr.sizeof_char*1, "/home/kishow/Desktop/wifi_rx.pcap", False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.foo_wireshark_connector_1, 'in'))    
        ...
        self.connect((self.foo_wireshark_connector_1, 0), (self.blocks_file_sink_2, 0))    
...
def main(top_block_cls=hackrf_wifi_receiver, options=None):
